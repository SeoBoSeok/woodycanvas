...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setBaseSize(QtCore.QSize(480, 480))
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setMinimumSize(QtCore.QSize(480, 480))
        self.centralWidget.setMaximumSize(QtCore.QSize(480, 480))
        self.centralWidget.setBaseSize(QtCore.QSize(480, 480))
        self.centralWidget.setObjectName("centralWidget")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralWidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 399, 301, 50))
        ...
        self.lblCamView.setGeometry(QtCore.QRect(0, 0, 480, 460))
        self.lblCamView.setMinimumSize(QtCore.QSize(480, 460))
        self.lblCamView.setMaximumSize(QtCore.QSize(480, 460))
        self.lblCamView.setBaseSize(QtCore.QSize(480, 460))
